  ...
  <div class="container p-4">
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 mb-4 mb-md-0 ">
        ...
        <ul class="list-unstyled p-0 m-0 mb-0">
          <li class="">
...
<a href="#"><i class="fa fa-linkedin fa-1x p-1" style="padding:3px;color:white;background-color:#33332F;border-radius:3px;"></i></a>
      </div></div>
      <!--Grid column-->
    </div>
    <!--Grid row-->
    ...
    <section class="">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
          ...
          <span class="text-white text-uppercase pb-0 pt-2">ADDRESS</span></span><br>
        ...
        <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
          ...
          <ul class="list-unstyled ">
            ...
            <li>
              <a href="#!" class="text-secondary text-decoration-none">Search</a>
            </li>
            <li>
