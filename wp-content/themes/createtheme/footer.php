    ...
    <section class="">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
         ...
         <a href="#"> <img src="http://localhost/wordpress/wp-content/uploads/2021/07/paypal-logo.png"  alt="..." width="50" height="30"></a>
      <a href="#"> <img src="http://localhost/wordpress/wp-content/uploads/2021/07/Visa1.jpg"  alt="..." width="50" height="30"></a>
      <a href="#"> <img src="http://localhost/wordpress/wp-content/uploads/2021/07/payments_12_550.png"  alt="..." width="50" height="30"></a>
      <a href="#"> <img src="http://localhost/wordpress/wp-content/uploads/2021/07/images.png"  alt="..." width="50" height="30"></a>
...
<p class="text-secondary">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ipsum facere quos reiciendis <br> <br>recusandae porro nesciunt! Modi dicta perferendis ipsum. Nobis consectetur dolorum neque!</p>
        </div>
        <!--Grid column-->
...
<h3 class="mb-3"><strong > (800) 123-4567</strong></h3>
<p class="text-secondary mb-0">International: (333) 456-6670</p>
<p class="text-secondary mb-0">Fax: (222) 531-8999</p>
<p class="text-secondary"><i class="fa fa-dot-circle-o pr-3" aria-hidden="true"></i>234 Street Name, City Name</p>
<i class="fa fa-envelope pr-3" aria-hidden="true"></i><a  class="text-secondary" href="mailto:some@email.com" target="_blank" >mail@example.com</a>
...
<br>
        ...
        <div class="row d-flex justify-content-center">
          ...
          <div class="col-md-10 col-12">
            ...
            <div class="form-outline form-white mb-4">
              <input type="name" id="form5Example2" class="form-control" placeholder="your name..." />
        ...
        <!--Grid row-->
         ...
         <div class="col-auto">
            <!-- Submit button -->
            <button type="submit" class="btn btn-outline-danger pl-4 pr-4">
              Submit
            </button>
          </div>
          <!--Grid column-->
...
<footer class="bg-dark text-white">
  ...
  <div class="container p-4">
    ...
    <div class="row">
      ...
      <!--Grid column-->
      <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
        <h5 class="text-uppercase mb-3">Opening Hours</h5>

        <ul class="list-unstyled">
          <li>
            <span href="#!" class="text-secondary">Mon-Fri:</span><span href="#!" class="text-white pl-2">8:30 am to 5:00 pm</span>
          </li>
          <li>
          <span href="#!" class="text-secondary">Mon-Fri:</span><span href="#!" class="text-white pl-2">8:30 am to 5:00 pm</span>
          </li>
      ...
      <!--Grid column-->
      <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
        <h5 class="text-uppercase mb-3">Call Us Now</h5>

        <ul class="list-unstyled mb-0">
          <li>
          <h4>  <strong href="#!" class="text-white">(800) 123 4567</strong></h4>
          </li>
          <li>
          <span href="#!" class="text-secondary">Sales: </span><span href="#!" class="text-white pl-2">(800) 123 4568</span>
          </li>
...
<a href="#"><i class="fa fa-linkedin fa-1x p-1" style="padding:5px;color:white;background-color:#33332F;border-radius:3px;"></i></a>
  ...
  <div class="payment-accounts p-2 ">
       <a href="#"> <img src="https://wp.7pixelsadv.com/wp-content/uploads/2021/07/paypal-logo.png"  alt="..." width="60" height="35"></a>
      <a href="#"> <img src="https://wp.7pixelsadv.com/wp-content/uploads/2021/07/Visa1.jpg"  alt="..." width="60" height="35"></a>
      <a href="#"> <img src="https://wp.7pixelsadv.com/wp-content/uploads/2021/07/payments_12_550.png"  alt="..." width="60" height="35"></a>
      <a href="#"> <img src="https://wp.7pixelsadv.com/wp-content/uploads/2021/07/images.png"  alt="..." width="60" height="35"></a>
<span class="payment-icon visa "></span>
